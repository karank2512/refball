...
works too. **Full step-by-step reproduction (from a fresh clone):** see
[`docs/REPRODUCE.md`](docs/REPRODUCE.md) — or just `bash scripts/run_demo.sh` (offline, ~2 min)
and `bash scripts/run_full.sh` (everything, ~4–6 hrs).
